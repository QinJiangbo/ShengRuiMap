...
<body>
	<div id="l-map"></div>
	<div id="result">
		<div id="open" class="btn_cloud">打开</div><div id="close" class="btn_cloud">关闭</div>
	</div>
	<!--城市列表-->
	<div class="sel_container"><strong id="curCity">武汉市</strong> [<a id="curCityText" href="javascript:void(0)">更换城市</a>]</div>
